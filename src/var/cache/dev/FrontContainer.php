...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['klaviyops.prestashop_services.context'] = new \KlaviyoPs\Classes\PrestashopServices\ContextService(${($_ = isset($this->services['klaviyops.prestashop_components.context']) ? $this->services['klaviyops.prestashop_components.context'] : $this->getKlaviyops_PrestashopComponents_ContextService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['klaviyops.util_services.env'] = new \KlaviyoPs\Classes\UtilServices\EnvService(${($_ = isset($this->services['klaviyops.module']) ? $this->services['klaviyops.module'] : $this->getKlaviyops_ModuleService()) && false ?: '_'});
    }
