    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                54 => ($this->targetDirs[3].'/modules/customcontactphonenumber/translations'),
                55 => ($this->targetDirs[3].'/modules/ps_mbo/translations'),
                56 => ($this->targetDirs[3].'/modules/ps_shoppingcart/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                60 => 'ht_staticblocks',
                61 => 'ht_brandlist',
                62 => 'ht_googleanalytics',
                63 => 'customcontactphonenumber',
                64 => 'ps_mbo',
                65 => 'ps_shoppingcart',
            ],
