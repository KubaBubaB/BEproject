    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                55 => ($this->targetDirs[3].'/modules/customcontactphonenumber/translations'),
                56 => ($this->targetDirs[3].'/modules/ps_mbo/translations'),
            ]; break;
